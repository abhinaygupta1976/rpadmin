...
export const axiosReducerCityPictureGet = (state, action) => {
  switch (action.type) {
...
export const axiosReducerCityPictureAdd = (state, action) => {
  switch (action.type) {
    case AXIOS_ACTION_TYPE.AXIOS_START:
      return {
        loading: true,
...
export const axiosReducerCityPictureDelete = (state, action) => {
  switch (action.type) {
    case AXIOS_ACTION_TYPE.AXIOS_START:
      return {
        loading: true,
